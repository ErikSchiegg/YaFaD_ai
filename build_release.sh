...
echo "🏗️  Building YaFaD v0.3.1 Release..."
...
go build -o release_v0.3.1/yafad_engine decay_worker.go

# Binary 2: The Simulator (User)
go build -o release_v0.3.1/yafad_simulator user_simulator.go

# 6. README kopieren (Optional aber empfohlen)
if [ -f "README.md" ]; then
    cp README.md release_v0.3.1/
fi

echo "✅ Build complete! Artifacts are in 'release_v0.3.1/'"
ls -lh release_v0.3.1/